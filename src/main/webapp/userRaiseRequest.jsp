...
<form style="margin-block-start: 96px;margin-left: 100px;margin-right: 700px;">
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="location" placeholder="Enter your desired location">
  </div>
  <div class="mb-3">
    <label for="vehiModel" class="form-label">Vehicle Model</label>
    <input type="text" class="form-control" id="vehiModel" placeholder="Enter the Model Number of your Vehicle">
  </div>
  <div class="mb-3">
